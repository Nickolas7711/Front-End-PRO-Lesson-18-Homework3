...
// Делаем на основании прошедшего дз. 
// В информации товара – кнопка "купить". 
// При нажатии на "Купить" ниже появляется форма оформления заказа со следующими полями: 
// ФИО покупателя 
// Город (выбор из списка) 
// Состав Новой почты для отправки 
// Наложенные платежи или оплаты банковской карты 
// Количество покупаемой продукции 
// Комментарий к заказу 
// 2. Реализовать проверку всех пользовательских данных при подтверждении заказа - обязательные поля заполнены. Иначе – выводить ошибку на страницу 
// 3. Выводить информацию о заказе на страницу (информация о товаре и о доставке)